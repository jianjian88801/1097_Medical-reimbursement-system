    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="财会审核人员姓名" prop="caikuaiName">
                       <el-input v-model="ruleForm.caikuaiName"
                                 placeholder="财会审核人员姓名" clearable  :readonly="ro.caikuaiName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="财会审核人员手机号" prop="caikuaiPhone">
                       <el-input v-model="ruleForm.caikuaiPhone"
                                 placeholder="财会审核人员手机号" clearable  :readonly="ro.caikuaiPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="caikuaiEmail">
                       <el-input v-model="ruleForm.caikuaiEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.caikuaiEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="电子邮箱" prop="caikuaiEmail">
                           <el-input v-model="ruleForm.caikuaiEmail"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   caikuaiName: [
                              { required: true, message: '财会审核人员姓名不能为空', trigger: 'blur' },
                          ],
                   caikuaiPhone: [
                              {  required: true, message: '财会审核人员手机号不能为空', trigger: 'blur' },
                              {  pattern: /^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/,
                                 message: '财会审核人员手机号格式不对',
                                 trigger: 'blur'
                              }
                          ],
                   caikuaiPhoto: [
                              { required: true, message: '财会审核人员头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`caikuai/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.caikuaiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
